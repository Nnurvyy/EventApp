    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4" x-data="{ showConfirmPassword: false }">
            ...
            <div class="relative mt-1">
                ...
                <button type="button" @click="showConfirmPassword = !showConfirmPassword" class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-teal-600 transition-colors focus:outline-none">
                    <!-- Eye Open Icon -->
        ...
        <div class="mt-8 flex flex-col gap-4">
            ...
            <div class="text-center mt-2">
                ...
                <a href="{{ route('login') }}" class="text-sm font-bold text-teal-600 hover:text-teal-700 transition-colors ms-1">Login di sini</a>
            </div>
        </div>
    </form>
</x-guest-layout>
